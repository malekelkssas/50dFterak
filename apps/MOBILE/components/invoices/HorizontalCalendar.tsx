    ...
    <View className="mb-4 w-full">
      ...
      <View className="flex-row items-center justify-between px-4 pb-4">
        <View className="flex-1 flex-row items-center">
          <Pressable onPress={handlePrevMonth} className="ml-[-8px] p-2">
          ...
          return (
            ...
            >
              <View className="absolute top-2 w-full items-center">
                <Badge
                  visible={hasInvoices && !isSelected}
                  className="bg-primary"
                >
                  {''}
                </Badge>
                <Badge visible={hasInvoices && isSelected} className="bg-white">
                  {''}
                </Badge>
              </View>
              <Text
                variant="bodySmall"
                className={`mt-1 mb-1 ${isSelected ? 'text-primary-on' : 'text-secondary'}`}
              >
                {item.dayName}
              </Text>
              <Text

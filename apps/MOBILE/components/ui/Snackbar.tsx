...
export function Snackbar({
  ...
  return (
    <Animated.View
      style={[{ opacity, bottom: bottom + 16 }, styles.absoluteBottom]}
      className={`bg-foreground elevation-4 mx-4 flex-row items-center justify-between rounded-md px-4 py-3 shadow-md ${className}`}
    >
      ...
      {action && (
        ...
        >
          <Text variant="labelLarge" className="text-primary ml-2 font-bold">
